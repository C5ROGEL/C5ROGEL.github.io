...
const electronicInvoicingImages = [
  "/img/Electronic Invoicing System/casos de uso -en.png",
  "/img/Electronic Invoicing System/casos de uso- es.png",
  "/img/Electronic Invoicing System/Creacion de doc, nota debito.png",
  "/img/Electronic Invoicing System/Dashboard de Facturas realizadas por emisor.png",
  "/img/Electronic Invoicing System/diagrama de proceso -en.png",
  "/img/Electronic Invoicing System/Diagrama de proceso -es.png",
  "/img/Electronic Invoicing System/documento a crear por emitir.png",
  "/img/Electronic Invoicing System/Documento Tributario Final (PDF).png",
  "/img/Electronic Invoicing System/Seleccion de emisor.png",
  "/img/Electronic Invoicing System/Seleccionador de tipo de receptor.png",
  "/img/Electronic Invoicing System/Visor de Documentos tributarios electronicos.png",
];

const clinicImages = [
  "/img/Clinic Management System/Inicio.png",
  "/img/Clinic Management System/Dashboard.png",
  "/img/Clinic Management System/Agregar medicamento a la lista de compras.png",
  "/img/Clinic Management System/Consulta de empleados.png",
  "/img/Clinic Management System/Creacion de nueva receta.png",
  "/img/Clinic Management System/Crear nuevo lote.png",
  "/img/Clinic Management System/Gestion de lista de compras.png",
  "/img/Clinic Management System/Gestion de lotes.png",
  "/img/Clinic Management System/Gestion de recetas.png",
  "/img/Clinic Management System/Inventario Medicamento.png",
  "/img/Clinic Management System/Modal crear medicamento + Lote.png",
];

const cinemaImages = [
  "/img/Cinema Management Platform/cine-.jpeg",
  "/img/Cinema Management Platform/Movie Interfaces.mp4",
  "/img/Cinema Management Platform/pelicula compartida por link directo.png",
  "/img/Cinema Management Platform/seleccioanr pelicula.png",
  "/img/Cinema Management Platform/trailer de pelicula.png",
];

const publicGatewayImages = [
  "/img/Maestra Publica/login.png",
  "/img/Maestra Publica/dashboard como usuario admin.png",
  "/img/Maestra Publica/datos para agregar nueva pelicula.png",
  "/img/Maestra Publica/gestion de banner de la web del cine.png",
  "/img/Maestra Publica/gestion de menus.png",
  "/img/Maestra Publica/gestion de peliculas.png",
  "/img/Maestra Publica/gestion de usuarios y perfiles ademas de permisos.png",
  "/img/Maestra Publica/menu lateral.png",
  "/img/Maestra Publica/permisos de menus por tipo de perfil usuario.png",
];

const multiTenantAuthImages = [
  "/img/Multi-Tenant Auth & Authorization System/clinic-api-token auth.png",
  "/img/Multi-Tenant Auth & Authorization System/clinic-endpoints.png",
  "/img/Multi-Tenant Auth & Authorization System/endpoints expanded.png",
  "/img/Multi-Tenant Auth & Authorization System/get categorias con bearer token.png",
  "/img/Multi-Tenant Auth & Authorization System/get-active-movies.png",
  "/img/Multi-Tenant Auth & Authorization System/swagger-version.png",
];

const pingMonitorImages = [
  "/img/PingMonitor/Dahsboard Principal.png",
  "/img/PingMonitor/agregar nueva ip.png",
  "/img/PingMonitor/gestion de marcadores (ips).png",
  "/img/PingMonitor/ip seleccionada con marca de 1H.png",
  "/img/PingMonitor/Latencia en tiempo real.png",
  "/img/PingMonitor/Linea temporal completa 1H seleccionada.png",
  "/img/PingMonitor/Notificaciones de alertas por correo.png",
];

const utilitiesApiImages = [
  "/img/Utilities API/Principal Dashboard.jpeg",
  "/img/Utilities API/Email Send History .png",
  "/img/Utilities API/emails send successfully.png",
  "/img/Utilities API/api correos pt1.jpeg",
  "/img/Utilities API/apicorreos pt2.jpeg",
  "/img/Utilities API/docker running.png",
  "/img/Utilities API/endpoint en postman.png",
];
